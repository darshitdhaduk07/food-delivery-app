...
import food_delivery_app.discount.NoDiscount;
...
public class FoodApp {
    ...
    static void setupInitialData() {
        ...
        DeliveryBoy d2 =
                new DeliveryBoy("Vivek","amit@mail.com",123);
    ...
    static void customerMenu() {
        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case 1 -> MenuStore.getMenu().display(0);

                case 2 -> {

                    MenuStore.getMenu().display(0);

                    int id = InputValidator.readInt("Enter Item ID: ");

                    MenuComponent comp =
                            MenuStore.getMenu().findById(id);
                    ...
                    if (comp instanceof MenuItem item) {
                        ...
                        System.out.println("Please Valid Item");
                    }
                }
